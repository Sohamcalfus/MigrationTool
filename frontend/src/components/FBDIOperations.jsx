...
import { Upload, Play, CheckCircle, XCircle, Clock, FileText, Settings, BarChart3 } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-gray-600 mt-1">Upload and process FBDI files through Oracle Cloud workflow</p>
            </div>
          </div>
          <button
            onClick={handleReset}
      ...
      {result && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-6">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-lg font-medium text-green-800">Workflow Completed Successfully!</h3>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <div>
                <h4 className="font-medium text-green-800 mb-2">UCM Upload</h4>
                <div className="text-sm text-green-700 space-y-1">
                  <p><span className="font-medium">Document ID:</span> {result.document_id}</p>
                  <p><span className="font-medium">Filename:</span> {result.ucm_filename}</p>
                </div>
              </div>
              
              <div>
                <h4 className="font-medium text-green-800 mb-2">Interface Loader</h4>
                <div className="text-sm text-green-700 space-y-1">
                  <p><span className="font-medium">Job ID:</span> {result.interface_job_id}</p>
                  <p><span className="font-medium">Status:</span> {result.interface_status}</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div>
                <h4 className="font-medium text-green-800 mb-2">AutoInvoice Import</h4>
                <div className="text-sm text-green-700 space-y-1">
                  <p><span className="font-medium">Job ID:</span> {result.autoinvoice_job_id}</p>
                  <p><span className="font-medium">Status:</span> {result.autoinvoice_status}</p>
                </div>
              </div>
              
              <div>
                <h4 className="font-medium text-green-800 mb-2">Parameters Used</h4>
                <div className="text-sm text-green-700 space-y-1">
                  <p><span className="font-medium">Business Unit:</span> {businessUnit}</p>
                  <p><span className="font-medium">Batch Source:</span> {batchSource}</p>
                  <p><span className="font-medium">GL Date:</span> {glDate}</p>
                </div>
              </div>
            </div>
          </div>
